...
class BattlegroundCAFPlayerKickedDialogView extends DialogView
{
	constructor()
	{
		super();
	...
	{	
		...
		//TEXTS...
		let msg = I18.generateNewCTranslatableAsset("TACafPrivateBattlegroundPlayerKicked");
...
export default BattlegroundCAFPlayerKickedDialogView;