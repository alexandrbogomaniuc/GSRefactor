...
class BattlegroundCAFRoundAlreadyStartedDialogView extends DialogView
{
	constructor()
	{
		super();
	...
	_initDialogView()
	{
		...
		this._messageContainer.position.set(-6, 17);
	}
	...
	{	
		...
		lOverlay_g.beginFill(0x000000).drawRect(0, 0, 960, 960).endFill();
		lOverlay_g.alpha = 1;
		lOverlay_g.position.set(-960 / 2, -960 / 2);
		this._baseContainer.addChild(lOverlay_g);
		//...OVERLAY

		//DIALOG BASE...
		let lFrame_g = lFrame_g = this._baseContainer.addChild(APP.library.getSprite("dialogs/battleground/frame"));
		...
		//TEXTS...
		let msg = I18.generateNewCTranslatableAsset("TACafPrivateBattlegroundRoundAlreadyStarted");
...
export default BattlegroundCAFRoundAlreadyStartedDialogView;