...
import { WEAPONS } from '../weapons/GUSWeaponsInfo';
import { APP } from '../../../unified/controller/main/globals';

class GUSLobbyWeaponsPanelInfo extends SimpleInfo
{
	constructor()
	{
		super();
	...
	{
		return !(this.currentWeaponShots > 0) && (this.selectedId > 0);
	}
...
export default GUSLobbyWeaponsPanelInfo;