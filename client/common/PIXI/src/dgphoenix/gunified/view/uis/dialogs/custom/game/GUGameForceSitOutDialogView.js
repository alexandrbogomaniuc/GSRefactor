...
class GUGameForceSitOutDialogView extends GUDialogView
{
	...
	_setMessage(messageId)
	{
		...
		if (this.uiInfo.compensateSpecialWeapons > 0 || this.uiInfo.totalReturnedSpecialWeapons > 0)
		{
			...
			let lMoneyField_tf = lTextContainer_sprt.addChild(new TextField(GUGameForceSitOutDialogView.MONEY_TEXT_FORMAT));
...
export default GUGameForceSitOutDialogView;