...
class WaitPendingOperationDialogController extends DialogController
{
	...
	__initControlLevel ()
	{
		...
		{
			lPendingOperationController_poc.on(LobbyPendingOperationController.EVENT_ON_PENDING_OPERATION_STARTTED, this._onPendingOperationStarted, this);
			lPendingOperationController_poc.on(LobbyPendingOperationController.EVENT_ON_PENDING_OPERATION_COMPLETED, this._onPendingOperationCompleted, this);
			lPendingOperationController_poc.on(LobbyPendingOperationController.EVENT_ON_PENDING_OPERATION_RESET, this._onPendingOperationStatusReset, this);
			lPendingOperationController_poc.on(LobbyPendingOperationController.EVENT_ON_ROOM_PENDING_OPERATION_STATUS_UPDATED, this._onRoomPendingOperationStatusUpdated, this);
		}
	}
