...
class BattlegroundRulesDialogView extends DialogView
{
	constructor()
	{
		super();
	...
	getScrollBarView()
	{
		...
		{
			this._fScrollBarView_sbv = this.addChild(new ScrollBarView());
			...
			this._fScrollBarView_sbv.on(ScrollBarView.EVENT_ON_SCROLL, this._onScrollBarScroll.bind(this));
		}
	...
	_onScroll(event)
	{
		...
		//console.log(this._fTextContainer_html.scrollTop + " / " + this._fTextContainer_html.scrollHeight);
	}
	...
	__retreiveDialogButtonViewInstance (aIntId_int)
	{
		...
		{
			case 0:
				lButton_btn = new ActiveGameDialogButton("lobby/battleground/back_to_lobby_button_base", "TABattlegroundRulesIUnderstand", undefined, undefined, ActiveGameDialogButton.BUTTON_TYPE_ACCEPT);
...
export default BattlegroundRulesDialogView;