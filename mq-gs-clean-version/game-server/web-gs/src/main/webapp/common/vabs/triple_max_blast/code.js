...
function processScreenData(publicText, text_start, text_step) {
    ...
    engine.drawTextStroke('BID ' + (screenIndex + 1) + " OF " + pagesRowData.length, center_x, 175, 2, COLOR_GRAY_60, true, 13, COLOR_WHITE);
...
function roundWithAutoEject(betParams, text_start, text_step) {
    engine.drawText('Bid: ' + toMoney(betParams[0]) + " Win: " + toMoney(betParams[1]),
