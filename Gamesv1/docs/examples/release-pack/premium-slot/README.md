...
This folder keeps intentionally committed examples of generated release-pack
metadata and review-safe shell token seeds.

Canonical behavior:

- Real release-pack outputs are generated under
  `games/<gameId>/release-packs/<releaseId>/`.
...
- Commit hex colors only when approved or explicitly marked as placeholders for
  review.
