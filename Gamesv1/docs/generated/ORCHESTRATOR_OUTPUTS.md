...
> Generated machine-specific output. Not canonical architecture/source-of-truth documentation.

Generated: 2026-03-01 11:01:41+00:00
...
corepack.cmd : (node:33140) [MODULE_TYPELESS_PACKAGE_JSON] Warning: Module type of 
file:///E:/Dev/GSRefactor/Gamesv1/tests/compliance/config.test.ts is not specified and it doesn't parse as CommonJS.
At line:2 char:186
+ ... -String).TrimEnd(); $testOut = (& corepack pnpm run test 2>&1 | Out-S ...
+                                     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    + CategoryInfo          : NotSpecified: ((node:33140) [M...se as CommonJS.:String) [], RemoteException
    + FullyQualifiedErrorId : NativeCommandError
 
Reparsing as ES module because module syntax was detected. This incurs a performance overhead.
To eliminate this warning, add "type": "module" to E:\Dev\GSRefactor\Gamesv1\package.json.
(Use `node --trace-warnings ...` to show where the warning was created)
(node:33140) [MODULE_TYPELESS_PACKAGE_JSON] Warning: Module type of 
...
(node:36012) [MODULE_TYPELESS_PACKAGE_JSON] Warning: Module type of 
...
(node:55832) [MODULE_TYPELESS_PACKAGE_JSON] Warning: Module type of 
...
## Simple repo tree from root (generated dirs filtered)
```text
Gamesv1/
├─ .agent/
│  ├─ context.md
