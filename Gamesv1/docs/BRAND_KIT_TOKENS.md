...
Brand kits provide lightweight visual injection for reusable shell surfaces without forking the runtime client.
...
- `primaryColor`: main shell accent color.
- `accentColor`: secondary highlight/glint color.
