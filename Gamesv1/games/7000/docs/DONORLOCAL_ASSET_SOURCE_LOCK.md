...
Previous regressions came from `_donor_raw_local` resolving via symlink to a different donor bundle than the approved baseline, which made donorlocal load wrong atlases/effects while the URL looked correct.
