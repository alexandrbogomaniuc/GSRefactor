...
- Spin captures commonly show four symbol columns with up to three visible symbols per column in readable rows. (Evidence: `Gamesv1/GameseDonors/ChickenGame/assets/_research_runs/ChickenGame/codex-phase1a-20260305-1323/OBSERVED_SPINS.csv`)
