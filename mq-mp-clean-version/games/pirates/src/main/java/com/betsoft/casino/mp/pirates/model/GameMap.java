...
import com.betsoft.casino.mp.pirates.model.math.EnemyPrize;
...
import static com.betsoft.casino.mp.pirates.model.math.SwarmType.RACING_RATS;
...
public class GameMap extends AbstractGameMap<Enemy, GameMapShape, EnemyRange, EnemyType, GameMap> {
    ...
    public boolean isNeedStandOnPlace(IEnemyType enemyType, int skinId) {
        return enemyType.isBoss() && getMapId() == 202 && skinId == PlayGameState.LEVIATHAN_SKIN_ID;
    }
