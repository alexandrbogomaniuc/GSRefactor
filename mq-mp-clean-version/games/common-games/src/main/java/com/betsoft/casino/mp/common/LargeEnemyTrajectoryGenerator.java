...
public class LargeEnemyTrajectoryGenerator extends TrajectoryGenerator {

    public LargeEnemyTrajectoryGenerator(GameMapShape map, PointI source, double speed) {
