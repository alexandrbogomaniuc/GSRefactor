...
public class SpawnConfigLoader {
    private static final String DEFAULT_CONFIG = "classpath:models/sectorx/spawn.json";

    private final Gson gson = new Gson();

    private static final Logger logger = LogManager.getLogger(SpawnConfigLoader.class);
    ...
    public SpawnConfig loadDefaultConfig() {
        ...
        try (Reader reader = new InputStreamReader(resource.getInputStream(), StandardCharsets.UTF_8)) {
            ...
            logger.error("Failed to read the SpawnConfig", e);
            return null;
        }
    }
