...
public class SpawnConfigValidator {
    ...
    public String validate(com.betsoft.casino.mp.bgsectorx.model.math.config.SpawnConfig spawnConfig) {
        ...
        /*if (bossParams.isBoundariesCheck() && (bossParams.getT1() < 10 || bossParams.getT1() > 20)) {
            return "bossParams: Must be 10<T1<20";
        }*/

        /*if (bossParams.isBoundariesCheck() && (bossParams.getT2() < 25 || bossParams.getT2() > 55)) {
            return "bossParams: Must be 20<T2<55";
        }*/
        ...
        com.betsoft.casino.mp.bgsectorx.model.math.config.HugePayItemsParams hugePayItemsParams = spawnConfig.getHugePayEnemiesParams();
