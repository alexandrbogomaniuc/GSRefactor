...
import com.betsoft.casino.mp.bgsectorx.model.math.SpawnStageFromConfig;
...
public class SpawnConfig implements ISpawnConfig {
    ...
    public SpawnConfig(int maxEntites, int maxNumOfTemporalFormationsPerScreen, int maxNumOfSpatialFormationsPerScreen, int maxNumOfClusterFormationsPerScreen,
                       ...
                       SpecialItemsParams specialItemsParams, com.betsoft.casino.mp.bgsectorx.model.math.config.HugePayItemsParams hugePayItemsParams, List<Long> specialItemsStayTimes, List<Long> hugePayItemsStayTimes, List<Double> highPayWeights, List<Double> midPayWeights,
