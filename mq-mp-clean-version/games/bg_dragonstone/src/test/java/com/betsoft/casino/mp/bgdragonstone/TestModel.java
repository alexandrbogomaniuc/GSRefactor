...
import com.betsoft.casino.mp.bgdragonstone.model.*;
...
public class TestModel {
    ...
    public static GameType gameType = GameType.BG_DRAGONSTONE;
    boolean roundIsFinished;
    boolean roundIsStarted;
    long minBosKills = 10000;
    long maxBosKills = 0;
    PlayerRoundInfo totalPlayerRoundsInfo = new PlayerRoundInfo(-1, false);
