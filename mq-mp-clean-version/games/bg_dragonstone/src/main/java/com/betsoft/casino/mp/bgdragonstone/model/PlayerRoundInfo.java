...
public class PlayerRoundInfo extends AbstractActionGamePlayerRoundInfo<EnemyType, EnemyStat, PlayerRoundInfo> {
    ...
    public PlayerRoundInfo(long roomId, boolean battlegroundMode) {
        this.gameId = (int) GameType.BG_DRAGONSTONE.getGameId();
        this.roomId = roomId;
    ...
    public static PlayerRoundInfo getPlayerRoundInfoFromVBAData(String data, double bets, double wins) {
        PlayerRoundInfo res = new PlayerRoundInfo(0, false);
    ...
    protected void fillPlayerRoundInfo(AbstractPlayerRoundInfo resA, String data, double bets, double wins) {
        ...
        for (String param : params) {
            if (param.contains("name=")) {
                ...
                com.betsoft.casino.mp.common.EnemyStat enemyStat = new com.betsoft.casino.mp.common.EnemyStat(false,
                        (int) GameType.DRAGONSTONE.getGameId());
