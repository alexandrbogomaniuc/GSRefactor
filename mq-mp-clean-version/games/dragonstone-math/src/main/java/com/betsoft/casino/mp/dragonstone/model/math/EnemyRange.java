...
import static com.betsoft.casino.mp.dragonstone.model.math.EnemyType.BROWN_RAT;
...
public enum EnemyRange implements IEnemyRange<EnemyType> {
    ...
    SPECIAL_ENEMIES(Arrays.asList(
            EnemyType.CERBERUS,
            EnemyType.DARK_KNIGHT,
            EnemyType.PURPLE_WIZARD,
            EnemyType.BLUE_WIZARD,
            EnemyType.RED_WIZARD)),
