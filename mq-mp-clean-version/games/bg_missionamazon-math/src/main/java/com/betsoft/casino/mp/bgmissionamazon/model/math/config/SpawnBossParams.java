...
public class SpawnBossParams {
    ...
    public SpawnBossParams(double a, double mu, double sigma, double lambda, int t1, int t2, int ta, int maxBosses, boolean boundariesCheck) {
        this.a = a;
        this.mu = mu;
        this.sigma = sigma;
        this.lambda = lambda;
