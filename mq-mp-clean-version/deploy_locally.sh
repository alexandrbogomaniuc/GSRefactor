...
BUILD_DIR="./web/target/web-mp-casino";
DEPLOY_DIR="/www/html/mp/ROOT";
...
#mvn -s config/settings.xml clean install -P volc-develop
mvn -s config/settings.xml clean install -P volc-develop -Dmaven.test.skip=true
