 ...
 * Date: 03.04.18.
 */
public class RoomTemplate implements IRoomTemplate, KryoSerializable {
    ...
    public RoomTemplate(long id, long bankId, GameType gameType, short maxSeats, short minSeats, MoneyType moneyType,
    ...
    public boolean isBattlegroundMode() {
        return getGameType().isBattleGroundGame();
    }
