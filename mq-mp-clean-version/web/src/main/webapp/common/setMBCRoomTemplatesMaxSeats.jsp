    ...
    private void updateMaxSeats(Collection<RoomTemplate> roomTemplates, RoomTemplateService roomTemplateService,
        ...
        for (RoomTemplate roomTemplate : roomTemplates) {
            if(roomTemplate.getGameType() == gameType) {
                LOG.debug("setMBCRoomTemplatesMaxSeats.jsp: Start update roomTemplate:{} maxSeats={} to {}", roomTemplate.getId(), roomTemplate.getMaxSeats(), maxSeats);
                ...
                try {
                    ...
                    LOG.error("setMBCRoomTemplatesMaxSeats.jsp: error to update maxSeats={} for the RoomTemplate={}", maxSeats, roomTemplate, exception);
                ...
                LOG.debug("setMBCRoomTemplatesMaxSeats.jsp: Finish update roomTemplate:{} maxSeats={} to {}", roomTemplate.getId(), roomTemplate.getMaxSeats(), maxSeats);
...
<%
    ...
    LOG.debug("setMBCRoomTemplatesMaxSeats.jsp: query={}", request.getQueryString());
