...
class GUDialogButton extends GUSLobbyButton
{
	...
	set buttonId(value)
	{
		...
		{
			case GUDialogButton.BUTTON_ID_OK:
			{
				this.setOKCaption();
				break;
			}
			case GUDialogButton.BUTTON_ID_CANCEL:
			{
				this.setCancelCaption();
				break;
			}
			case GUDialogButton.BUTTON_ID_CUSTOM:
			{
				// no default caption
				break;
			}
	...
	get isOkButton()
	{
		return this._buttonId == GUDialogButton.BUTTON_ID_OK;
	}

	get isCancelButton()
	{
		return this._buttonId == GUDialogButton.BUTTON_ID_CANCEL;
	}

	get isCustomButton()
	{
		return this._buttonId == GUDialogButton.BUTTON_ID_CUSTOM;
	}
