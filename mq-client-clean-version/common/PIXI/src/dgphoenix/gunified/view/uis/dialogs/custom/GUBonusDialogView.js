...
class GUBonusDialogView extends GUDialogView
{
	constructor()
	{
		super();
	...
	_setMessage(messageId, aOptValue_num = undefined, aOptValue_str = undefined, aOptSubString_str = undefined)
	{
		...
		let lValue_str = "";
		if (
			messageId === "TADialogBonusRoomIntro"		//these messages have no money value
			|| messageId === "TADialogBonusLobbyIntro"
			)
		{
...
export default GUBonusDialogView;