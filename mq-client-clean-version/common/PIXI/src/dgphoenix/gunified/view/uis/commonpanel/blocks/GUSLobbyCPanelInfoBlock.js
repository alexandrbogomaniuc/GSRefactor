...
import GUSLobbyWeaponsPanelController from '../../../../controller/custom/GUSLobbyWeaponsPanelController';
import GUSLobbyFRBController from '../../../../controller/custom/frb/GUSLobbyFRBController';
import GUSLobbyCPanelInfoBlockFreeShotsLabel from './GUSLobbyCPanelInfoBlockFreeShotsLabel';

class GUSLobbyCPanelInfoBlock extends Sprite
{
	hideFreeLabel()
	{
	...
	{
		return new GUSLobbyCPanelInfoBlockFreeShotsLabel(); 
	}

	_init()
	{
		let l_lwpc = APP.commonPanelController.lobbyWeaponsPanelController;
		l_lwpc.on(GUSLobbyWeaponsPanelController.EVENT_ON_INFO_UPDATED, this._onInfoUpdated, this);

		let l_frbc = APP.FRBController;
		l_frbc.on(GUSLobbyFRBController.EVENT_ON_FRB_STATE_CHANGED, this._onInfoUpdated, this);

		this._fInfoBlockFreeShotsLabel_ibfsl = this.addChild(this.__provideInfoBlockFreeShotsLabelInstance());
...
export default GUSLobbyCPanelInfoBlock