(window.createjs = window.createjs || {}),
  ...
  (function () {
    ...
    p.addEventListener = function (
      ...
      if (!type) {
        throw (
          "Error trying to add event listener: undefined event type; listener: " +
          listener
        );
      }
      if (!listener) {
        throw (
          "Error trying to add event listener: undefined listener; event type: " +
          type +
          "; context: " +
          context
        );
    ...
    p.removeEventListener = function (type, listener, useCapture, context) {
      if (type === undefined) {
        throw (
          "Error trying to remove event listener: undefined event type; listener: " +
          listener
        );
      }
      if (!listener) {
        throw (
          "Error trying to remove event listener: undefined listener; event type: " +
          type +
          "; context: " +
          context
        );
      ...
      if (typeof context == "number") {
        throw (
          "Error trying to remove event listener: incorrect context type, number provided; listener: " +
          listener
        );
      }
    ...
    p._compareListenersPriority = function (event1, event2) {
      ...
      return priorDlt === 0
        ? event2.regPriority - event1.regPriority
        : priorDlt;
    };
...
(window.createjs = window.createjs || {}),
    ...
    (XHRRequest.ACTIVEX_VERSIONS = [
      ...
      (a._createXHR = function (a) {
        ...
        if (window.XMLHttpRequest)
          ...
          for (var e = 0, f = b.ACTIVEX_VERSIONS.length; f > e; e++) {
            var g = b.ACTIVEX_VERSIONS[e];
            try {
  ...
  (function () {
    ...
    (a.context = null),
      ...
      (b._sendComplete = function () {
        a.context
          .decodeAudioData(
            ...
            //Betsoft correction ...
            createjs.proxy(this._handleAudioDecodeError, this)
          )
          .catch((reason) => {
      ...
      //Betsoft correction ...
      (b._handleAudioDecodeError = function (event) {
  ...
  (function () {
    ...
    (b.context = null),
      ...
      * @since 0.4.1
      */
      (a._cleanUpAudioNode = function (audioNode) {
        if(audioNode) {
          audioNode.stop(0);
          audioNode.disconnect(0);
          // necessary to prevent leak on iOS Safari 7-9. will throw in almost all other
          // browser implementations.
          try { audioNode.buffer = b._scratchBuffer; } catch(e) {}
          audioNode = null;
        }
        return audioNode;
      }),
      //Betsoft correction.....
      (a._handleSoundReady = function (event) {
            this.gainNode.connect(b.destinationNode);  // this line can cause a memory leak.  Nodes need to be disconnected from the audioDestination or any sequence that leads to it.
        
            var dur = this._duration * 0.001;
            var pos = this._position * 0.001;
            if (pos > dur) {pos = dur;}
            this.sourceNode = this._createAndPlayAudioNode((b.context.currentTime - dur), pos);
      ...
      */
      //Betsoft correction.....
      (a._createAndPlayAudioNode = function (startTime, offset) {
        var audioNode = b.context.createBufferSource();
       ...
       * @private
       */
      (a._applyPanningToNode = function (srcNode, gainNode, panValue) {
        ...
        if (
          ...
          // No support (old browser or old iOS Safari)
        ...
        } // More than 2 channels (3 - 6), no panning. Could be inplemented in future, if we use sounds with more channels.
        else {
          splitterNode.disconnect(0);
          srcNode.disconnect(0);
          srcNode.connect(gainNode);
       ...
       * @private
       */
      (a._calculateGane = function (inputValues, azimuth) {
       ...
       * @private
       */
      (a._prepareAzimuth = function (azimuth) {
       ...
       * @private
       */
      (a._getGainValues = function (azimuth) {
       ...
       * @private
       */
      (a._getNormalizedValue = function (azimuth) {
        if (azimuth <= 0) {
          // -90 -> 0
      ...
      (a._pause = function () {
        ...
        this._position = (b.context.currentTime - this._playbackStartTime) * 1000; // * 1000 to give milliseconds, lets us restart at same point
        this.sourceNode = this._cleanUpAudioNode(this.sourceNode);
        this._sourceNodeNext = this._cleanUpAudioNode(this._sourceNodeNext);
