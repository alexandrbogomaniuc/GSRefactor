...
class PseudoGameWebSocketInteractionController extends WebSocketInteractionController
{
	...
	_closeConnection()
	{
		...
		APP.tournamentModeController.off(TournamentModeController.EVENT_ON_TOURNAMENT_STATE_CHANGED, this._onTournamentModeStateChanged, this);
		APP.pendingOperationController.off(LobbyPendingOperationController.EVENT_ON_PENDING_OPERATION_COMPLETED, this._onPendingOperationCompleted, this);
