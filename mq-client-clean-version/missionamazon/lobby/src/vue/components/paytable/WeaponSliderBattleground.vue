<template>
	<div>
		...
		<div id="bet_slider">
			<div id="currentBet" ref='currentBet' style="white-space: nowrap;"></div>
			<BaseTextField 
				id="betLevelCapture"
...
<script type="text/javascript">
	...
	const WEAPONS_ARRAY = [
		...
		{betLevel: null, weaponID: WEAPONS.RICOCHET},
		...
		methods: {
			...
			_getWeaponConfig(aWeaponId_num, aBetLevel)
			{
				switch(aWeaponId_num)
				{
					...
					case 4:	return {src: "paytable/pages/enemies/weapon_slider/weapons/gun_off", top: -28, left: 12, ctaAssetID: "TAPaytableEnemiesWeaponsPlasmaRifle"};
					case 3:	return {src: "paytable/pages/enemies/weapon_slider/weapons/laser", top: -5, left: -22, ctaAssetID: "TAPaytableEnemiesWeaponsLaser"};
			...
			handleWeaponPrewButtonClick()
			{
				...
				if(this.currentWeaponsQueueIndex < 0)
				{
					...
					this.currentBetLevel = 3;
				}

				this.currentWeaponID = WEAPONS_QUEUE[this.currentWeaponsQueueIndex].weaponID;

				switch (this.currentBetLevel)
				{
					case 3:
						if(this.currentWeaponID === -1)
						{
							this.currentBetLevel = 10;
						}
						break;
					case 5:
						this.currentBetLevel = 3;
			...
			handleWeapnNextButtonClick()
			{
				...
				{
					case 3:
						if(this.currentWeaponID === -1 && this.currentWeaponsQueueIndex != 0)
						{
							this.currentBetLevel = 5;
						}
						break;
