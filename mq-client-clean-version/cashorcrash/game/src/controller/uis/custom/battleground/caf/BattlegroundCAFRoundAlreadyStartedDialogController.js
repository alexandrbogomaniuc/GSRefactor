...
class BattlegroundCAFRoundAlreadyStartedDialogController extends DialogController
{
	...
	__initControlLevel ()
	{
		...
		gamePlayersController.on(GamePlayersController.EVENT_ROUND_ALREADY_STARTED_DIALOG, this._eventRoundAlreadyStarted, this);
		// DEBUG...
	...
	_eventRoundAlreadyStarted(event)
	{
	...
	__activateDialog()
	{
		...
		console.log('activate round already started dialog super ')

		super.__activateDialog();
	}
}

export default BattlegroundCAFRoundAlreadyStartedDialogController