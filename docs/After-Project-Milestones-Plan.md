...
- `docs/audit-evidence/` (new evidence folder)
- `docs/Requirement-Reality-Check-Audit.md` (main plain-English audit report)
...
- `docs/Architecture-Workflow-Visual-Pack.md`
...
- `docs/Config-Portal-User-Guide.md`
