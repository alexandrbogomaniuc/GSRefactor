...
- phase4_protocol_status: NO_GO_RUNTIME_FAILURE
- phase5_6_extraction_status: NO_GO_RUNTIME_FAILURE
...
|---|---|---|
| phase4_runtime_parity_go_missing | HIGH | NO_GO_RUNTIME_FAILURE |
| phase5_6_runtime_go_missing | HIGH | NO_GO_RUNTIME_FAILURE |
