# Phase 4 Protocol Runtime Evidence (20260224-163329 UTC)
...
```text
FAIL: protocol-adapter canary route decision is not enabled for bank 6275
Decision payload: {"routeEnabled":false,"canaryBanks":["6275"],"bankId":"6275","routeToProtocolAdapter":false,"failOpenLegacyPath":true,"protocolMode":"JSON","reason":"legacy_fallback"}
```
