# Hard-Cut M2 Wave 36 Report (AllServersOfflineException)

Date (UTC): 2026-02-26
Project: `02-runtime-renaming-refactor`
Milestone: `M2 - package migration`
Wave: `W36-all-servers-offline-exception`
Status: `COMPLETE`
...
- Exception package declaration migration with no dependent import rewrites.

## Next wave proposal
- M2 Wave 37: continue with next low-fanout exception/config declaration migration.
