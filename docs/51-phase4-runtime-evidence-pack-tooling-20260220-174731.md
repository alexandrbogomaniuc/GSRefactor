...
- `/Users/alexb/Documents/Dev/Dev_new/docs/phase4/protocol/phase4-protocol-runtime-evidence-20260220-174754.md`
- Observed blockers in this environment:
  - protocol-adapter endpoint not reachable on `127.0.0.1:18078`,
  - Docker socket permission denied (`unix:///Users/alexb/.docker/run/docker.sock`) for wallet probe.
