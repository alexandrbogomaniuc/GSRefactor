...
public class BurstShootingStrategyWithoutBuySW implements IRoomBotStrategy {
    ...
    public BurstShootingStrategyWithoutBuySW(int stakesLimit) {
    ...
    public long getWaitTime() {
        ...
        if (time < lockTime) {
            long waitTime = lockTime - time;
            return waitTime < MIN_SHOT_PAUSE ? MIN_SHOT_PAUSE : waitTime;
        }
        if (shots == 0) {
