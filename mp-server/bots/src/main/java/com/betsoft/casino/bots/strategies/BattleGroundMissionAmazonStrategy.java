...
public class BattleGroundMissionAmazonStrategy implements IRoomBotStrategy {
    private static final int MIN_WAIT_BETWEEN_ACTIONS = 1000;
    private static final int MAX_WAIT_BETWEEN_ACTIONS = 4000;
    private static final Logger LOG = LogManager.getLogger(BattleGroundMissionAmazonStrategy.class);
    ...
    public BattleGroundMissionAmazonStrategy(int stakesLimit, int requestedBetLevel, boolean allowedUseDroppedSW, long requestedByInAmount) {
    ...
    public boolean shouldShoot(String botId) {
        ...
        LOG.debug("BattleGroundMissionAmazonStrategy shouldShoot: activeWeaponId:{}, shots: {}", activeWeaponId, shots);
        return true;
    }
    ...
    public boolean shouldSwitchWeapon() {
        ...
        LOG.debug("BattleGroundMissionAmazonStrategy shouldSwitchWeapon activeWeaponId {}, " +
    ...
    public String toString() {
        return "BattleGroundMissionAmazonStrategy{" + "LOG=" + LOG +
                ", lockTime=" + LOCK_TIME +
                ", shots=" + shots +
