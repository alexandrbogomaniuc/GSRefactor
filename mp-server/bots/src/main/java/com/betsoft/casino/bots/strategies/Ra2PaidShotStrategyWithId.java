...
public class Ra2PaidShotStrategyWithId implements IRoomBotStrategy {
    ...
    public Ra2PaidShotStrategyWithId(int stakesLimit, int requestedWeaponPaidId, int requestedBetLevel) {
        ...
        for (SpecialWeaponType type : SpecialWeaponType.values()) {
            if (type.getAvailableGameIds().contains((int) GameType.REVENGE_OF_RA.getGameId())
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("Ra2PaidShotStrategyWithId{");
