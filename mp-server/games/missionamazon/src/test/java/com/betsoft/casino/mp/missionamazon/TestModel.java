package com.betsoft.casino.mp.missionamazon;
...
public class TestModel {
    ...
    public static GameType gameType = GameType.MISSION_AMAZON;
    ...
    public void doTestRound(boolean debug, Set<EnemyType> enemiesForSpecialWeapons, int cntPlayers,
        ...
        StubRoomTemplate stubRoomTemplate = new StubRoomTemplate(1, 271, gameType,
                ...
                1, 1, "Test Room", 5);
        String fileStatsName = getDebugFileName(allowSpecialWeaponsShoots, idEnemiesForShooting, coinInCents, cntRealShotsRequired, betLevel, needUsePaidWeapons, paidWeaponId);
        ...
        GameRoom currentRoom = getCurrentRoom(config, spawnConfig, roomInfo, seats, currentMap);
        ...
        for (Seat seat : seats) {
            ...
            stakesBySeats.put(seat.getNickname(), (1 + mult * 1000L));
            mult++;
        }
        currentRoom.start();
        int limit = 500000;
        ...
        while (!needFinish) {
            ...
            while (currentRoom.getGameState().getRoomState().equals(RoomState.PLAY)) {
                ...
                if (realShots.get() >= cntRealShotsRequired) {
                    ...
                    System.out.println("-----------------------------------doFinishWithLock");
                    break;
                }
...
////                    }
    ...
    private String getDebugFileName(boolean allowSpecialWeaponsShoots, String idEnemiesForShooting, int coinInCents, int cntRealShotsRequired, int betLevel, boolean needUsePaidWeapons, int paidWeaponId) {
    ...
    private GameRoom getCurrentRoom(GameConfig config, SpawnConfig spawnConfig, ISingleNodeRoomInfo roomInfo, List<Seat> seats, GameMap currentMap) {
