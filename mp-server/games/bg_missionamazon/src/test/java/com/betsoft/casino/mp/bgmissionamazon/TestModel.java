package com.betsoft.casino.mp.bgmissionamazon;

import com.betsoft.casino.mp.bgmissionamazon.model.*;
...
public class TestModel {
    ...
    public static GameType gameType = GameType.BG_MISSION_AMAZON;
    ...
    public static void main(String[] args) throws Exception {
        ...
        boolean debug = false;
        int cntPlayers = 1;
        boolean allowSpecialWeaponsShoots = false;
