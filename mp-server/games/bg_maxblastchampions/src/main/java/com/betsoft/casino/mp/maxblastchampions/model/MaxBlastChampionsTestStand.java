...
public class MaxBlastChampionsTestStand {
    private final int featureId;
    private final TestStandFeature feature;

    public MaxBlastChampionsTestStand() {
        this.featureId = 0;
        this.feature = null;
    }

    public MaxBlastChampionsTestStand(TestStandFeature feature) {
    ...
    public String toString() {
        return "MaxBlastChampionsTestStand{" +
                "feature=" + feature +
                '}';
    }
}
