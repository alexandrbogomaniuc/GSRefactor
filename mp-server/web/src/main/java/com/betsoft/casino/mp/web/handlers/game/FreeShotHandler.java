...
import com.betsoft.casino.mp.transport.AddFreeShotsToQueue;
...
@Component
public class FreeShotHandler extends AbstractRoomHandler<AddFreeShotsToQueue, IGameSocketClient> {
    private static final Logger LOG = LogManager.getLogger(FreeShotHandler.class);

    public FreeShotHandler(IMessageSerializer serializer, SingleNodeRoomInfoService singleNodeRoomInfoService,
    ...
    @Override
    public void handle(WebSocketSession session, AddFreeShotsToQueue message, IGameSocketClient client) {
                ...
                try {
                    ...
                    if (seat == null || client.getAccountId() == null || seat.getAccountId() != client.getAccountId()) {
                        ...
                        try {
                            ...
                            room.addFreeShotsToQueue(seat, message);
                            StatisticsManager.getInstance().updateRequestStatistics("FreeShotHandler: processShot",
