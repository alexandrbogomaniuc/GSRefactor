 ...
 * Date: 17.08.18.
 */
public class AddWinResult implements IAddWinResult {
    ...
    public AddWinResult(boolean playerOffline, long balance, boolean success, int errorCode, String errorDetails) {
