...
This document describes the communication protocol between client and the server in the “CrashGame BTG” multiplayer game. +
...
.Response:
{
  ...
  "bets": [
     {"ejectMultiplier": 1.5, ejectTime: 1656575901701, betId: "1656575888324_1_drose"},
     {"ejectMultiplier": 1.5, ejectTime: 1656575901701,name: "drose", betId: "1656575888324_2_drose"},
     {"ejectMultiplier": 0, ejectTime: 0, name: "drose", betId: "1656575888324_3_drose"}
  ],
  "state": "PLAY",
  "seats": [
    {
...
crashBetKey:: key of crash bet (will be needed later in cancel of bet)
balance:: current balance in cents
currentRoundTime:: Time since the start of the round
