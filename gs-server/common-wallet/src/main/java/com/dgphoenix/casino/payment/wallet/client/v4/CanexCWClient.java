...
import com.abs.casino.common.client.canex.request.friends.GetFriendsOutput;
import com.abs.casino.common.client.canex.request.friends.GetFriendsRequest;
import com.abs.casino.common.client.canex.request.friends.GetFriendsResponse;
import com.abs.casino.common.client.canex.request.onlineplayer.GetOnlinePlayersOutput;
import com.abs.casino.common.client.canex.request.onlineplayer.GetOnlinePlayersRequest;
import com.abs.casino.common.client.canex.request.onlineplayer.GetOnlinePlayersResponse;
import com.abs.casino.common.client.canex.request.onlinerooms.PushRoomsPlayersOutput;
import com.abs.casino.common.client.canex.request.onlinerooms.PushRoomsPlayersRequest;
import com.abs.casino.common.client.canex.request.onlinerooms.Room;
import com.abs.casino.common.client.canex.request.privateroom.InvitePlayersOutput;
import com.abs.casino.common.client.canex.request.privateroom.InvitePlayersRequest;
