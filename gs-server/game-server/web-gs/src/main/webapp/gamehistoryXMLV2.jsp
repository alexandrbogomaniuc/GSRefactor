...
%>
<bean:define id="form" name="GameHistoryXMLListFormV2" type="com.dgphoenix.casino.web.history.GameHistoryXMLListFormV2"/>
<%
    ...
    Attribute[] attributes = new Attribute[12];
    ...
    attributes[11] = new Attribute(ATTR_MODE, String.valueOf(form.getMode() < 0 || form.getMode() > 3 ? 0 : form.getMode()));
