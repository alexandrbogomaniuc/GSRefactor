    ...
    <div class="section">
        ...
        <table class="table table-bordered table-striped table-condensed">
            ...
            <tr>
                ...
                <td><code>docs/30-phase9-abs-rename-wave-plan-gs-v1.md</code><br/><code>docs/139-phase9-abs-compatibility-mapping-manifest-and-validator-20260224-094500.md</code><br/><code>docs/140-phase9-abs-rename-candidate-scan-and-review-only-block-gate-20260224-100000.md</code></td>
            </tr>
            </tbody>
        </table>
    </div>
