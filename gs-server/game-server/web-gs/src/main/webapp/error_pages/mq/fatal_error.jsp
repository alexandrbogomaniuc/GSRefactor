...
<%
    ...
    String gameIdFromRequest = request.getParameter("gameId");

    if (isNotBlank(gameIdFromRequest)) {
        try {
            long gameId = Long.parseLong(gameIdFromRequest);

            switch ((int)gameId) {
                case 829: //REVENGEOFRA
                    gamePrefix = "ror";
                    break;
                case 838: //DRAGONSTONE
                case 856: //BG_DRAGONSTONE
                    gamePrefix = "ds";
                    break;
                case 859: //MISSION_AMAZON
                case 862: //BG_MISSION_AMAZON
                    gamePrefix = "amazon";
                    break;
                case 864: //BG_MAXCRASHGAME
                    gamePrefix = "max-blast-champs";
                    break;
                case 866: //SECTOR_X
                case 867: //BG_SECTOR_X
                    gamePrefix = "sectorx";
                    break;
                case 875: //TRIPLE_MAX_BLAST
                    gamePrefix = "triple-max-blast";
                    break;
            }
...
<head>
    ...
    <style type="text/css">
        ...
        .container {
            ...
            width: 100%;
            height: 100%;
            background-image: url("/images/error-pages/mq/<%=gamePrefix%>-bg.jpg");
...
<div class="container">
    <div class="content">
        ...
        <div class="brand">
            <img alt="Max Quest" src="/images/error-pages/mq/<%=gamePrefix%>-logo.png"/>
        </div>
