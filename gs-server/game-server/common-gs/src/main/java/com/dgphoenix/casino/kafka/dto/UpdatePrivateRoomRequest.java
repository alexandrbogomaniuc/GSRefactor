...
public class UpdatePrivateRoomRequest implements KafkaRequest {
    private String privateRoomId;
    private List<BGPlayerDto> players;
    private int bankId;

    public UpdatePrivateRoomRequest() {}

    public UpdatePrivateRoomRequest(String privateRoomId, List<BGPlayerDto> players, int bankId) {
